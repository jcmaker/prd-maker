...
├── commands/prd-maker.md          # /prd-maker 슬래시 커맨드
└── .claude-plugin/                # 플러그인 + 셀프 마켓플레이스 메타데이터
```
...
**Claude Code 전용인가요?**
플러그인 자체는 Claude Code용이지만, **산출되는 PRD는 순수 마크다운**이라 Cursor, Codex, Replit 등 어떤 AI 코딩 도구에도 넣을 수 있습니다.
