...
<img src="assets/demo.gif" alt="prd-maker 인터뷰 데모 — 아이디어에서 검증된 PRD.md까지 한 흐름" width="720">
...
### 전체 예시 PRD 문서
- [북마크 관리 SaaS PRD (개발자 트랙)](docs/examples/bookmark-saas.md)
- [습관 형성 소비자 앱 PRD (비개발자 트랙)](docs/examples/consumer-app.md)
